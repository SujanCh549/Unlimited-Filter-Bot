...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "🗃️<i> Fɪʟᴇ Nᴀᴍᴇ:<a href="https://t.me/FilmyHub_Adda">{file_name}</a></i>\n\n🔘<i> Sɪᴢᴇ:<a href="https://t.me/FilmyHub_Adda">{file_size}</a></i>")
