...
BOT_TOKEN = environ.get('BOT_TOKEN', '6002778950:AAFq3Vw4l2pGiWXVqb6YHQJR2cxzYLLNMtY')
...
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 't.me/Sujan_BotZ')

# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001978535504'))
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "🗃️<i> Fɪʟᴇ Nᴀᴍᴇ: <a>{file_name}</a></i>\n\n🔘<i> Sɪᴢᴇ: <a>{file_size}</a></i>\n\n<i><a>Uploaded By ~ @FilmyHub_Adda</a></i>")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001813638350')).split()]
